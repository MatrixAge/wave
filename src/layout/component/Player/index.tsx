...
const Index = () => {
	return (
		...
		>
			<div className='player border_box flex justify_between align_center relative'>
				...
				<div className='controls_wrap w_100 h_100 absolute left_0 flex justify_center align_center'>
				...
				<div className='options_wrap flex align_center'>
					...
					<UnorderedListOutlined className='option' />
				</div>
			</div>
		</div>
	)
